...
(defclause relative-datetime-padded
  n    (s/cond-pre (s/eq :current) s/Int)
  unit (optional RelativeDatetimeUnit))
...
(def ^:private FieldOrRelativeDatetime
  (s/conditional
    (partial is-clause? :relative-datetime) relative-datetime
    (partial is-clause? :relative-datetime-padded) relative-datetime-padded
    :else Field))
